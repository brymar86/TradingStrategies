...
class TradePro_Daily:
    ...
    """This is a Strategy where we used technical indicators that attempt to produce a scalping type of strategy.
    
    Backtesting this it doesn't appear that it produces 'scalping'  type of results but rather captures trends fairly
    well at daily time intervals.   The idea was from youtube TradePro where it allegedly won numerous competitions. 
    
    youtube.com/watch?v=7NM7bR2mL7U&t=0s 
   ...
   """
    ...
    def signal(self):
        ...
        """To pass dictionary object to BinanceTrader Class.  NOT FOR GITHUB. I'm keeping my BinanceTrader Class Private.""" 
        ...
        take_profit_price = self.df.iloc[-1]['atr'] * 2
        stop_loss = self.df.iloc[-1]['atr']*3
...
class Backtest(TradePro_Daily):
    ...
    """This is my Bact testor.  I plan to improve upon this but so long as one can get the holding period returns one can run analytics. 
    
    The way i build strategies I try and stay consistent so my inheritance is easier. 
    
    The main idea I have is scalability.  This Backtestor requires Strategy class object above to be able to have a properly formed 
    Strategy with buys and sell values as so the backtestor can calculate the appropriate holding period returns in the 
    calc_profit method
    ...
    def calc_profit(self):
        ...
        May make a log-return method but I find that not as pressing. """
    ...
    def Annualized_Strategy_Ret(self):
        ...
        # this is how one calculates the annualized return once you have HPR. 
        Ra = ((1 + Rc)**(1/n))-1
    ...
    def Max_Liklihood(self):
        ...
        return Distribution. To improve on a later date """
    ...
    def Monte_Carlo_VaR(self, num_reps = 10000, n = 1000, VaR_Level = 5):
        ...
        This method will also be alterered to a degree.  Requires class objects of capital at risk: int
        and Holding period returns captured in a numpy array. 
